...
public extension Endpoints {
    ...
    func requestWithGenerics<ValidServerResponse : Codable>  (
        ...
        if self.queryParameter != nil {
            ...
            Alamofire.request(_url, method: method, parameters: parameters,
            ...
            print(_url)
            Alamofire.request(_url, method: method, parameters: parameters,encoding: encoding , headers:header).responseJSON { (response) in
                self.handleGenerics(response, responseClosure: { (result, code, model : ValidServerResponse?,error : APIError?)  in
                    responseClosure(result,code,model,error)
                })
            }
    ...
    private func handleGenerics<ValidServerResponse : Codable>(_ response: DataResponse<Any>, responseClosure: @escaping GenericWebResponse<ValidServerResponse>) {
